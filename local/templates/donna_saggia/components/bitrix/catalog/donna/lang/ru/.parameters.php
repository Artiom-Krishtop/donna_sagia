...
$MESS["CPT_BC_TPL_SET_MENU_TYPE"] = "Укажите тип меню";
$MESS["CPT_BC_TPL_CHILD_MENU_TYPE"] = "Тип меню для остальных уровней";
$MESS["CPT_BC_TPL_USE_EXT"] = "Подключать файлы с именами вида .тип_меню.menu_ext.php";
...
$MESS['B_C_TAG_SEARCH'] = 'Тег для предварительной фильтрации';
$MESS['B_C_PREFILTER_NAME'] = 'Имя входящего массива для дополнительной фильтрации элементов';
